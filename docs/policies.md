...
This page applies site-wide, to every theme sold here.
...
## Refunds, Returns & Cancellations {: .f1-heading }

Because these are digital goods delivered instantly on purchase, all
sales are final: there are no refunds, returns, or cancellations once a
