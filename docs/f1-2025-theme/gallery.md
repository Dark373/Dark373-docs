...
![F1 2025 Theme render 35](gallery-images/render-35.webp){: width=1400 height=1088 loading=lazy data-location="Drivers and line-ups -> Line-Ups tab" data-theme="Team-coloured rows fill the whole canvas edge-to-edge; no neutral background is visible to confirm the Background Colour Theme setting" }
