...
![F1 2025 Theme render 11](gallery-images/render-11.webp){: width=1256 height=1400 loading=lazy data-location="Penalties -> Penalties tab, right-click a row" data-theme="Document facsimile; not driven by Background Colour Theme" }
...
![F1 2025 Theme render 27](gallery-images/render-27.webp){: width=1400 height=859 loading=lazy data-location="Session Results -> Statistics tab -> Top Battles" data-theme="Season Colour (set via league categories, not a Background Colour Theme option)" }
![F1 2025 Theme render 28](gallery-images/render-28.webp){: width=1228 height=1400 loading=lazy data-location="Penalties -> Penalties tab, right-click a row" data-theme="Document facsimile; not driven by Background Colour Theme" }
...
!!! tip "Filling in the hover captions"
    ...
    **Render Location** and **Theme Option**. To edit one, find that
    image's line in this file (`docs/f1-2025-theme/gallery.md`) and edit
